...
from ultralytics_local.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from ultralytics_local.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _resume_or_create_experiment(args: SimpleNamespace) -> None:
    ...
    try:
        ...
        experiment.log_other("Created from", "ultralytics_local")
...
def _log_plots(experiment, trainer) -> None:
    ...
    Examples:
        >>> from ultralytics_local.utils.callbacks.comet import _log_plots
...
def on_fit_epoch_end(trainer) -> None:
    ...
    if curr_epoch == 1:
        from ultralytics_local.utils.torch_utils import model_info_for_loggers
