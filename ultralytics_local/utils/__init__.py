...
from ultralytics_local.utils.git import GitRepo
from ultralytics_local.utils.patches import imread, imshow, imwrite, torch_save  # for patches
from ultralytics_local.utils.tqdm import TQDM  # noqa
...
LOGGING_NAME = "ultralytics_local"
...
HELP_MSG = """
    ...
    1. Install the ultralytics_local package:

        pip install ultralytics_local
...
class DataExportMixin:
    ...
    def to_df(self, normalize=False, decimals=5):
        ...
        """
        import polars as pl  # scope for faster 'import ultralytics_local'
...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(
            f"""
            '{name}' object has no attribute '{attr}'. This may be caused by a modified or out of date ultralytics_local
            'default.yaml' file.\nPlease update your code with 'pip install -U ultralytics_local' and if necessary replace
...
def plt_settings(rcparams=None, backend="Agg"):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            import matplotlib.pyplot as plt  # scope for faster 'import ultralytics_local'
...
def set_logging(name="LOGGING_NAME", verbose=True):
    ...
    Examples:
        >>> set_logging(name="ultralytics_local", verbose=True)
        >>> logger = logging.getLogger("ultralytics_local")
...
class ThreadingLocked:
    ...
    Examples:
        >>> from ultralytics_local.utils import ThreadingLocked
        >>> @ThreadingLocked()
        >>> def my_function():
        ...    # Your code here
    """
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        from ultralytics_local.utils.torch_utils import torch_distributed_zero_first
    ...
    def _validate_settings(self):
        ...
        if not (correct_keys and correct_types and correct_version):
            LOGGER.warning(
                ...
                f"with your settings or a recent ultralytics_local package update. {self.help_msg}"
            )
            self.reset()
...
def vscode_msg(ext="ultralytics_local.ultralytics_local-snippets") -> str:
