...
Usage:
    from ultralytics_local.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_local import YOLO, YOLOWorld
from ultralytics_local.cfg import TASK2DATA, TASK2METRIC
from ultralytics_local.engine.exporter import export_formats
from ultralytics_local.utils import ARM64, ASSETS, IS_JETSON, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR, YAML
from ultralytics_local.utils.checks import IS_PYTHON_3_13, check_imgsz, check_requirements, check_yolo, is_rockchip
from ultralytics_local.utils.downloads import safe_download
from ultralytics_local.utils.files import file_size
from ultralytics_local.utils.torch_utils import get_cpu_info, select_device
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt: str = "datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("ultralytics_local-benchmarks")
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> from ultralytics_local.utils.benchmarks import ProfileModels
