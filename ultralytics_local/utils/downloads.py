...
from ultralytics_local.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file

# Define Ultralytics GitHub assets maintained at https://github.com/ultralytics/assets
GITHUB_ASSETS_REPO = "ultralytics_local/assets"
...
def delete_dsstore(path: str | Path, files_to_delete: tuple[str, ...] = (".DS_Store", "__MACOSX")) -> None:
    ...
    Examples:
        >>> from ultralytics_local.utils.downloads import delete_dsstore
...
def zip_directory(
    ...
    Examples:
        >>> from ultralytics_local.utils.downloads import zip_directory
...
def unzip_file(
    ...
    Examples:
        >>> from ultralytics_local.utils.downloads import unzip_file
...
def get_google_drive_file_info(link: str) -> tuple[str, str | None]:
    ...
    Examples:
        >>> from ultralytics_local.utils.downloads import get_google_drive_file_info
...
def get_github_assets(
    repo: str = "ultralytics_local/assets",
    version: str = "latest",
    retry: bool = False,
) -> tuple[str, list[str]]:
    ...
    Examples:
        >>> tag, assets = get_github_assets(repo="ultralytics_local/assets", version="latest")
    """
    import requests  # scoped as slow import
...
def attempt_download_asset(
    ...
    **kwargs,
    ...
    Examples:
        >>> file_path = attempt_download_asset("yolo11n.pt", repo="ultralytics_local/assets", release="latest")
    """
    from ultralytics_local.utils import SETTINGS  # scoped for circular import
