...
from ultralytics_local.utils import NOT_MACOS14
from ultralytics_local.utils.tal import TORCH_1_10, dist2bbox, dist2rbox, make_anchors
from ultralytics_local.utils.torch_utils import fuse_conv_and_bn, smart_inference_mode
    ...
    def forward(self, x: list[torch.Tensor], batch: dict | None = None) -> tuple | torch.Tensor:
        ...
        Returns:
            outputs (tuple | torch.Tensor): During training, returns a tuple of bounding boxes, scores, and other
                ...
                class scores.
        """
        from ultralytics_local.models.utils.ops import get_cdn_group
