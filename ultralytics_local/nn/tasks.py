...
from ultralytics_local.nn.Addmodules.DA_Net import C3k2_DAB, DualAttentionBlock
from ultralytics_local.nn.Addmodules.DTAB import C3k2_DTAB
from ultralytics_local.nn.Addmodules.iAFF import AFF, iAFF
...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            c2 = channels[0]  # output of the iAFF module ( output channel is either of the channels)
            args = [c2]
        elif m in {CA, SimAM}:
            c2 = ch[f]
            args = [c2, *args]
