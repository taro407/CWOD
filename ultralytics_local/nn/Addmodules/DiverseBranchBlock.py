...
__all__ = ["C3k2_DBB_backbone", "C3k2_DBB_neck", "DiverseBranchBlock"]
...
class Bottleneck_DBB(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):  # ch_in, ch_out, shortcut, groups, kernels, expand
        ...
        self.cv2 = DiverseBranchBlock(c_, c2, 3, stride=1, groups=g)
...
class C3k2_DBB_backbone(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_DBB(self.c, self.c, shortcut, g)
            for _ in range(n)
        )


class C3k2_DBB_neck(C2f):
    """Faster Implementation of CSP Bottleneck with 2 convolutions."""
