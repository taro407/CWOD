...
Requirements:
    $ pip install "ultralytics_local[export]"
...
from ultralytics_local import __version__
from ultralytics_local.cfg import TASK2DATA, get_cfg
from ultralytics_local.data import build_dataloader
from ultralytics_local.data.dataset import YOLODataset
from ultralytics_local.data.utils import check_cls_dataset, check_det_dataset
from ultralytics_local.nn.autobackend import check_class_names, default_class_names
from ultralytics_local.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from ultralytics_local.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from ultralytics_local.utils import (
    ARM64,
    DEFAULT_CFG,
    IS_COLAB,
    IS_JETSON,
...
from ultralytics_local.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from ultralytics_local.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from ultralytics_local.utils.export import *
from ultralytics_local.utils.files import file_size, spaces_in_path
from ultralytics_local.utils.metrics import batch_probiou
from ultralytics_local.utils.nms import TorchNMS
from ultralytics_local.utils.ops import Profile
from ultralytics_local.utils.patches import arange_patch
from ultralytics_local.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
class Exporter:
    ...
    Examples:
        ...
        >>> from ultralytics_local.engine.exporter import Exporter
        >>> exporter = Exporter()
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/ultralytics_local/ultralytics_local/pull/13420
        ...
        if imx:
            from ultralytics_local.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from ultralytics_local.utils.tal import make_anchors
