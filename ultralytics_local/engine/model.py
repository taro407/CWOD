...
from ultralytics_local.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_local.engine.results import Results
from ultralytics_local.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        if self.is_hub_model(model):
            from ultralytics_local.hub import HUBTrainingSession
    ...
    def is_hub_model(model: str) -> bool:
        ...
        Examples:
            ...
            False
        """
        from ultralytics_local.hub import HUB_WEB_ROOT
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("ultralytics_local")) and any(
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_local.trackers import register_tracker
    ...
    def val(
        ...
        **kwargs: Any,
        ...
        Args:
            validator (ultralytics_local.engine.validator.BaseValidator, optional): An instance of a custom validator
                class for validating the model.
    ...
    def benchmark(self, data=None, format="", verbose=False, **kwargs: Any):
        ...
        It uses the 'benchmark' function from the ultralytics_local.utils.benchmarks module. The benchmarking is
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics_local.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ultralytics_local.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_local.utils.tuner import run_ray_tune
    ...
    def names(self) -> dict[int, str]:
        ...
        using the 'check_class_names' function from the ultralytics_local.nn.autobackend module. If the predictor is not
