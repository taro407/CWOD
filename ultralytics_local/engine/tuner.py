...
from ultralytics_local.utils import DEFAULT_CFG, LOGGER, YAML, callbacks, colorstr, remove_colorstr
from ultralytics_local.utils.checks import check_requirements
from ultralytics_local.utils.patches import torch_load
from ultralytics_local.utils.plotting import plot_tune_results
...
class Tuner:
    ...
    def __init__(self, args=DEFAULT_CFG, _callbacks: list | None = None):
        ...
        mongodb_db = args.pop("mongodb_db", "ultralytics_local")
    ...
    def __call__(self, model=None, iterations: int = 10, cleanup: bool = True):
        ...
        for i in range(start, iterations):
            ...
            try:
                ...
                launch = [__import__("sys").executable, "-m", "ultralytics_local.cfg.__init__"]  # workaround yolo not found
