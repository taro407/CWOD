...
from ultralytics_local.data import load_inference_source
from ultralytics_local.data.augment import LetterBox
from ultralytics_local.nn.autobackend import AutoBackend
from ultralytics_local.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from ultralytics_local.utils.checks import check_imgsz, check_imshow
from ultralytics_local.utils.files import increment_path
from ultralytics_local.utils.torch_utils import attempt_compile, select_device, smart_inference_mode
...
class BasePredictor:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        Yields:
            (ultralytics_local.engine.results.Results): Results objects.
        """
