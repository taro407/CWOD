...
from ultralytics_local.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX
from ultralytics_local.utils import IS_COLAB, LOGGER, SETTINGS, TQDM, checks, emojis
from ultralytics_local.utils.errors import HUBModelError
...
class HUBTrainingSession:
    ...
    def __init__(self, identifier: str):
        ...
        self.timers = {}  # holds timers in ultralytics_local/utils/callbacks/hub.py
        self.model = None
        self.model_url = None
