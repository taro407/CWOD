...
from ultralytics_local.data.utils import IMG_FORMATS, img2label_paths
from ultralytics_local.utils import DATASETS_DIR, LOGGER, TQDM
...
def autosplit(
    ...
    Examples:
        ...
        >>> from ultralytics_local.data.split import autosplit
        >>> autosplit()
