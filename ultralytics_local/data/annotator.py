...
from ultralytics_local import SAM, YOLO
...
def auto_annotate(
    ...
    Examples:
        >>> from ultralytics_local.data.annotator import auto_annotate
        >>> auto_annotate(data="ultralytics_local/assets", det_model="yolo11n.pt", sam_model="mobile_sam.pt")
    """
