...
from ultralytics_local.utils import LOGGER
from ultralytics_local.utils.checks import check_requirements
from ultralytics_local.utils.downloads import GITHUB_ASSETS_STEMS
...
class Inference:
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        """
        check_requirements("streamlit>=1.29.0")  # scope imports for faster ultralytics_local package load speeds
    ...
    def source_upload(self) -> None:
        ...
        from ultralytics_local.data.utils import IMG_FORMATS, VID_FORMATS  # scope import
        ...
        if self.source == "video":
            ...
            if vid_file is not None:
                ...
                with open("ultralytics_local.mp4", "wb") as out:  # Open temporary file as bytes
                    out.write(g.read())  # Read bytes into file
                self.vid_file_name = "ultralytics_local.mp4"
