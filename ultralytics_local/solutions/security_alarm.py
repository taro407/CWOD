...
from ultralytics_local.solutions.solutions import BaseSolution, SolutionAnnotator, SolutionResults
...
class SecurityAlarm(BaseSolution):
    ...
    def send_email(self, im0, records: int = 5) -> None:
        ...
        # Attach the image
        image_attachment = MIMEImage(img_bytes, name="ultralytics_local.jpg")
