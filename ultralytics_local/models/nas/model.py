...
from ultralytics_local.engine.model import Model
from ultralytics_local.utils import DEFAULT_CFG_DICT
...
from ultralytics_local.utils.torch_utils import model_info
...
class NAS(Model):
    ...
    Examples:
        >>> from ultralytics_local import NAS
        >>> model = NAS("yolo_nas_s")
        >>> results = model.predict("ultralytics_local/assets/bus.jpg")
