...
from ultralytics_local.data import YOLOConcatDataset, build_grounding, build_yolo_dataset
from ultralytics_local.data.utils import check_det_dataset
from ultralytics_local.models.yolo.world import WorldTrainer
from ultralytics_local.utils import DATASETS_DIR, DEFAULT_CFG, LOGGER
from ultralytics_local.utils.torch_utils import unwrap_model
...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    Examples:
        >>> from ultralytics_local.models.yolo.world.train_world import WorldTrainerFromScratch
        >>> from ultralytics_local import YOLOWorld
        >>> data = dict(
        ...     train=dict(
