...
```bash
python FSC.py --model-cfg BSD.yaml --source-data path/to/source.yaml --target-data path/to/target.yaml
python CMM.py --model-cfg BSD.yaml --source-data path/to/source.yaml --target-data path/to/target.yaml
```
